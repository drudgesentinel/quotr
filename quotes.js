const quotes = [
  {"author": "Marcus Aurelius", "quote": "The soul becomes dyed with the color of its thoughts."},
  {"author": "Epictetus", "quote": "Wealth consists not in having great possessions, but in having few wants."},
  {"author": "Epictetus", "quote": "Working within our sphere of control, we are naturally free, independent, and strong. Beyond that sphere, we are weak, limited, and dependent."},
  {"author": "Seneca", "quote": "They lose the day in expectation of the night, and the night in fear of the dawn."},
  {"author": "Seneca", "quote": "If a man knows not to which port he sails, no wind is favorable."},
  {"author": "Friedrich Nietzsche", "quote": "The surest way to corrupt a youth is to instruct him to hold in higher esteem those who think alike than those who think differently."},
